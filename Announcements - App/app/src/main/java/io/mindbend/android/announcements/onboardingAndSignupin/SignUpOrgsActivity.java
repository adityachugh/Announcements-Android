    ...
    private void loadTopLevelOrgs(ProgressBar progressBar){
        OrgsDataSource.getAllTopLevelOrganizations(progressBar, new FunctionCallback<ArrayList<Organization>>() {
            ...
            public void done(ArrayList<Organization> organizations, ParseException e) {
                if (e == null){
                    OrgsGridFragment orgsGridFragment = OrgsGridFragment.newInstance(organizations, mOrgInteractionListener, mOrgsGridInteractionListener, true);
            ...
            public void done(ArrayList<Organization> organizations, ParseException e) {
                if (e == null) {
                    if (organizations.size() != 0) {
                        OrgsGridFragment childrenOrgs = OrgsGridFragment.newInstance(organizations, mOrgInteractionListener, mOrgsGridInteractionListener, true);
                        FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
